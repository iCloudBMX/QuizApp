    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamAttendants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamAttendants_Exams_ExamId",
                        column: x => x.ExamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttendantAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AttendantAnswers_ExamAttendants_ExamAttendantId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AttendantAnswers_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendantAnswers_ExamAttendantId",
                table: "AttendantAnswers",
                column: "ExamAttendantId");

            migrationBuilder.CreateIndex(
                name: "IX_AttendantAnswers_ExamId",
                table: "AttendantAnswers",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_AttendantAnswers_OptionId",
                table: "AttendantAnswers",
                column: "OptionId");
